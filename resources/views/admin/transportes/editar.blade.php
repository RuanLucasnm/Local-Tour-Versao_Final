...
@section('title', 'Editar Transporte - Local Tour')
...
<div class="form-container">
    ...
    <form method="POST" action="/admin/transportes/{{ $transporte->id_transporte }}">
        @csrf
        @method('PUT')

        <div class="form-group">
            <label for="tipo_transporte">Tipo de Transporte *</label>
            <input type="text" id="tipo_transporte" name="tipo_transporte" value="{{ old('tipo_transporte', $transporte->tipo_transporte) }}" required placeholder="Ex: Ônibus">
        ...
        <div class="form-group">
            ...
            <input type="text" id="companhia" name="companhia" value="{{ old('companhia', $transporte->companhia) }}" required placeholder="Ex: Expresso Brasil">
            @error('companhia')
                <div class="error-message">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn-submit">Atualizar Transporte</button>
